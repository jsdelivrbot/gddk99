                        ...
                        <form class="am-form">
                            <table class="am-table am-table-striped am-table-hover table-main">
                                ...
                                <tr>
                                    ...
                                    <td class="am-hide-sm-only">{{ $mem_val['member_type'] or '无' }}</td>
                                    <td class="am-hide-sm-only">{{ $mem_val['updated_at'] or '无' }}</td>
                                    <td>
                                        <div class="am-btn-toolbar">
                                            <div class="am-btn-group am-btn-group-xs">
                                                <a href="{{ url('/admin/member-list-edit',['member_id'=>$mem_val['member_id']]) }}" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>
