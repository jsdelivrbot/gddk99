    ...
    <div class="tpl-portlet-components">
        <div class="portlet-title">
            <div class="caption font-green bold">
                <span class="am-icon-code"></span> 顾客新增表单
            </div>
        </div>
        <div class="tpl-block ">
            ...
            <div class="am-g tpl-amazeui-form">
                ...
                <div class="am-u-sm-12 am-u-md-9">
                    {!! Form::open(['url'=>'admin/consultant-store','files'=>'true','class'=>'am-form am-form-horizontal','data-am-validator']) !!}
                        <fieldset>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" id="con_name" name="con_name" placeholder="输入顾问姓名" required>
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" id="con_tel" name="con_tel" placeholder="输入顾客电话" required>
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" id="con_person" name="con_person" placeholder="输入顾客咨询人数" required>
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <input type="text" id="con_time" name="con_time" placeholder="输入顾问从业时间" required>
                            </div>
                        </div>
                        ...
                        <div class="am-form-group">
                            ...
                            <div class="am-u-sm-9">
                                <textarea class="" rows="5" id="con_content" name="con_content" placeholder="输入个人介绍" required></textarea>
                            </div>
                        </div>
