...
@section('content')
    <div class="pet_mian" >
        <div class="pet_head">
            <header data-am-widget="header"
                ...
                <h1 class="am-header-title pet_article_user">
                    ...
                    <span class="pet_article_user_ico"><img src="{{ url('build/img/a1.png') }}" alt="" class=""></span>
        ...
        <div class="pet_content">
            <div class="pet_content_block">
                ...
                <div class="pet_article_dowload"> </div>
            </div>
                        ...
                        <div class="am-tabs-bd pet_pl_list">
                            <div data-tab-panel-0 class="am-tab-panel am-active">
                                <div class="pet_comment_list_block">
                                    <div class="pet_comment_list_block_l"><img src="{{ url('build/img/a1.png') }}" alt=""></div>
                                ...
                                <div class="pet_comment_list_block">
                                    <div class="pet_comment_list_block_l"><img src="{{ url('build/img/a2.png') }}" alt=""></div>
                                    <div class="pet_comment_list_block_r">
                                ...
                                <div class="pet_comment_list_block">
                                    <div class="pet_comment_list_block_l"><img src="{{ url('build/img/a3.png') }}" alt=""></div>
                                    <div class="pet_comment_list_block_r">
                                ...
                                <div class="pet_comment_list_block">
                                    <div class="pet_comment_list_block_l"><img src="{{ url('build/img/a4.png') }}" alt=""></div>
                                    <div class="pet_comment_list_block_r">
                        ...
                        <div class="am-list-news-bd">
                            <ul class="am-list">
                                ...
                                <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_list_one_block">
                                    <div class="pet_list_one_info">
                                        <div class="pet_list_one_info_l">
                                            <div class="pet_list_one_info_ico"><img src="{{ url('build/img/a1.png') }}" alt=""></div>
                                ...
                                <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_list_one_block">
                                    <div class="pet_list_one_info">
                                        <div class="pet_list_one_info_l">
                                            <div class="pet_list_one_info_ico"><img src="{{ url('build/img/a6.png') }}" alt=""></div>
                                    ...
                                    <div class="am-u-sm-4 am-list-thumb pet_video_info">
                                        ...
                                        <a href="###" class="">
                                            <img src="{{ url('build/img/q4.jpg') }}" class="pet_list_one_img" alt="我很囧，你保重....晒晒旅行中的那些囧！"/>
                                        </a>
                                    </div>
                                </li>
                                <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_list_one_block">
                                    <div class="pet_list_one_info">
                                        <div class="pet_list_one_info_l">
                                            <div class="pet_list_one_info_ico"><img src="{{ url('build/img/a2.png') }}" alt=""></div>
                                ...
                                <li class="am-g am-list-item-desced pet_list_one_block">
                                    <div class="pet_list_one_info">
                                        <div class="pet_list_one_info_l">
                                            <div class="pet_list_one_info_ico"><img src="{{ url('build/img/a3.png') }}" alt=""></div>
  ...
  am-avg-md-3 am-avg-lg-3 am-gallery-default pet_list_one_list" >
                                            <li>
                                                <div class="am-gallery-item">
                                                    <a href="###" class="">
                                                        <img src=" {{ url('build/img/qq1.jpg') }}"  alt="某天 也许会相遇 相遇在这个好地方"/>
                                                    </a>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="am-gallery-item">
                                                    <a href="###" class="">
                                                        <img src=" {{ url('build/img/qq2.jpg') }}" alt="不要太担心 只因为我相信"/>
                                                    </a>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="am-gallery-item">
                                                    <a href="###" class="">
                                                        <img src="{{ url('build/img/qq3.jpg') }}"  alt="终会走过这条遥远的道路"/>
                                                    </a>
                                                </div>
                                            </li>
                                        </ul>
  ...
  am-avg-md-3 am-avg-lg-3 am-gallery-default pet_list_one_list pet_list_one_tytj" >
                                            <li>
                                                <div class="am-gallery-item">
                                                    <a href="###" class="">
                                                        <img src=" {{ url('build/img/w1.jpg') }}"  alt="某天 也许会相遇 相遇在这个好地方"/>
                                                    </a>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="am-gallery-item">
                                                    <a href="###" class="">
                                                        <img src="{{ url('build/img/w2.jpg') }}"  alt="不要太担心 只因为我相信"/>
                                                    </a>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="am-gallery-item">
                                                    <a href="###" class="">
                                                        <img src="{{ url('build/img/w3.jpg') }}"  alt="终会走过这条遥远的道路"/>
                                                    </a>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="am-gallery-item">
                                                    <a href="###" class="">
                                                        <img src=" {{ url('build/img/w4.jpg') }}"  alt="终会走过这条遥远的道路"/>
                                                    </a>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="am-gallery-item">
                                                    <a href="###" class="">
                                                        <img src="{{ url('build/img/w5.jpg') }}"  alt="终会走过这条遥远的道路"/>
                                                    </a>
                                                </div>
                                            </li>
                                            <li>
                                                <div class="am-gallery-item">
                                                    <a href="###" class="">
                                                        <img src="{{ url('build/img/w6.jpg') }}"  alt="终会走过这条遥远的道路"/>
                                                    </a>
                                                </div>
                                            </li>
                                        </ul>
                                ...
                                <li class="am-g am-list-item-desced pet_list_one_block">
                                    <div class="pet_list_one_info">
                                        <div class="pet_list_one_info_l">
                                            <div class="pet_list_one_info_ico"><img src="{{ url('build/img/a4.png') }}" alt=""></div>
                                ...
                                <li class="am-g am-list-item-desced pet_list_one_block">
                                    <div class="pet_list_one_info">
                                        <div class="pet_list_one_info_l">
                                            <div class="pet_list_one_info_ico"><img src="{{ url('build/img/a5.png') }}" alt=""></div>
                                    ...
                                    <div class=" am-list-main">
                                        ...
                                        <div class="pet_list_zt_img"><img src="{{ url('build/img/c1.png') }}" alt=""></div>
                                ...
                                <li class="am-g am-list-item-desced pet_list_one_block">
                                    <div class="pet_article_user_block">
                                        <div class="pet_article_user_img">
                                            ...
                                            <img src="{{ url('build/img/c2.png') }}" alt=""></div>
                                        <div class="pet_article_user_info">
                                            <div class="pet_article_user_info_ico"><img src="{{ url('build/img/c.png') }}" alt=""></div>SeeYouAgain
                                        </div>
