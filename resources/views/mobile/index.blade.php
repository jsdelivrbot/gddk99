    ...
    <div class="pet_mian" id="top">
        ...
        <div class="pet_circle_nav">
            <ul class="pet_circle_nav_list">
                ...
                @if($member['member_type']==\App\Member::MEMBER_TYPE_THREE)
            ...
            <div class="pet_more_list"><div class="pet_more_list_block">
                    ...
                    <div class="pet_more_list_block">
                        <div class="pet_more_list_block_name">
                            <a href="http://wechat.lrh.vcredit.com/qdRegister?appChannel=dalianzhongshanyongmengtouzi" class="pet_more_list_block_line">
                                <i class="iconfont pet_nav_xinxianshi pet_more_list_block_line_ico">&#xe61e;</i>
                                <div class="pet_more_list_block_line_font">丽人荟</div>
                            </a>
                            <a href="http://hl.vcash.cn/resource/huanle_weixin/download.html" class="pet_more_list_block_line">
                                <i class="iconfont pet_nav_zhangzhishi pet_more_list_block_line_ico">&#xe607;</i>
                                <div class="pet_more_list_block_line_font">还乐</div>
                            </a>
                        </div>
                    </div>
