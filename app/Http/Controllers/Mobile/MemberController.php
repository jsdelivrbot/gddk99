...
class MemberController extends Controller
{
    ...
    public function unionPerson(Request $request,Member $member,Common $common){
        ...
        // 生成二维码
        $Qrcode = $common->QrCode($memberID,$this->path,$this->HttpUrl,280);
    ...
    public function Poster(Common $common,Member $member){
        ...
        if(!file_exists($poster)){
            $common->Poster($common->picUrlPath('hbbg.png'),$common->PublicPath('qrcode',$memberId),$common->PublicPath('sc',$memberId),$dst_x='190',$dst_y='370');
        }
